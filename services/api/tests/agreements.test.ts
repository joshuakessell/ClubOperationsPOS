...
describe('Agreement and Upgrade Flows', () => {
  ...
  describe('Agreement Endpoints', () => {
    it('should return active agreement', runIfDbAvailable(async () => {
  ...
  describe('Agreement Signing', () => {
    it('should require agreement signature for initial check-in', runIfDbAvailable(async () => {
    ...
    it('should require agreement signature for renewal', runIfDbAvailable(async () => {
      const sessionResponse = await fastify.inject({
        method: 'POST',
        url: '/v1/sessions',
        payload: {
    ...
    it('should reject agreement signing for upgrades', runIfDbAvailable(async () => {
    ...
    it('should store agreement text snapshot even when empty', runIfDbAvailable(async () => {
      const sessionResponse = await fastify.inject({
        method: 'POST',
        url: '/v1/sessions',
        payload: {
  ...
  describe('Upgrade Disclaimer', () => {
    it('should log upgrade disclaimer when joining waitlist', runIfDbAvailable(async () => {
      const sessionResponse = await fastify.inject({
        method: 'POST',
        url: '/v1/sessions',
        payload: {
    ...
    it('should not log disclaimer for normal check-in without upgrade intent', runIfDbAvailable(async () => {
      const sessionResponse = await fastify.inject({
        method: 'POST',
        url: '/v1/sessions',
        payload: {
