/**
 * TailAdmin Pro Alert — adapted for @club-ops use.
 * Upstream: components/ui/alert/Alert.tsx
 * Changed: replaced react-router Link with native <a>, added onClose support
 */
