...
- Open **employee-kiosk** (lane 1), **customer-kiosk** (lane 1), and optionally **office-dashboard**.
...
- In employee-kiosk, click **“Verify agreement PDF + signature saved”** and confirm:
...
- **Waitlist**: waitlist entry appears in employee-kiosk left panel immediately after creation (no ~30s delay).
