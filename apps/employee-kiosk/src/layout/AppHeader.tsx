...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full border-gray-800 bg-gray-900 z-99999 xl:border-b">
      <div className="flex items-center justify-between grow px-3 py-2 xl:px-4">
        <div className="flex items-center gap-2">
          <button
            className={`items-center justify-center w-10 h-10 text-gray-400 border-gray-800 rounded-lg z-99999 flex lg:h-11 lg:w-11 xl:border ${
              isMobileOpen ? "bg-white/[0.03]" : ""
            }`}
        ...
        <button
          ...
          className="flex items-center justify-center w-10 h-10 text-gray-400 rounded-lg z-99999 hover:bg-gray-800 xl:hidden"
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
