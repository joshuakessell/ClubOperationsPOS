...
export const es: Record<keyof typeof en, string> = {
  ...
  'selection.subtitle': 'Elige una membresía y un tipo de cuarto para continuar.',
  ...
  // Common
  dashboard: 'Panel',
  kiosk: 'Kiosco de clientes',
  poweredBy: 'Con tecnología de Club Ops',
  checkIn: 'Check-in',
  checkout: 'Salida',
  ...
  checkoutsToday: 'Check-outs de hoy',
  inventoryStatus: 'Estado de inventario',
  roomLockerStatus: 'Estado de cuartos y lockers',
  live: 'En vivo',
  quickActions: 'Acciones rápidas',
  actionsForStaff: 'Acciones para staff',
  staffOnly: 'Solo staff',
  readyForNextGuest: 'Listo para el siguiente invitado',
  waitingForStaff: 'Esperando al staff para iniciar la sesión',
  dashboardSubtitle: 'Resumen de ocupación en tiempo real',
  'rooms.standard': 'Cuartos estándar',
  'rooms.double': 'Cuartos dobles',
  'rooms.special': 'Cuartos especiales',
  'rooms.lockers': 'Lockers',
  ...
  'agreement.bypassMessage': 'Espera mientras el staff completa la firma física del acuerdo.',
