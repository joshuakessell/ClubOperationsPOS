...
export const en = {
  ...
  'selection.subtitle': 'Select a membership and room type to continue.',
  ...
  roomLockerStatus: 'Room / Locker Status',
  live: 'Live',
  quickActions: 'Quick Actions',
  actionsForStaff: 'Actions for Staff',
  staffOnly: 'Staff Only',
  readyForNextGuest: 'Ready for the next guest',
  waitingForStaff: 'Waiting for staff to start a session',
  dashboardSubtitle: 'Live occupancy snapshot for the front desk',
  'rooms.standard': 'Standard Rooms',
  'rooms.double': 'Double Rooms',
  'rooms.special': 'Special Rooms',
  ...
  'agreement.bypassMessage': 'Please wait while staff completes a physical agreement signature.',
