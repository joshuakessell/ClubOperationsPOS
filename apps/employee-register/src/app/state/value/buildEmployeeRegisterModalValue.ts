...
export function buildEmployeeRegisterModalValue(params: EmployeeRegisterModalParams) {
  ...
  return {
    ...
    scanCameraOverlayVisible: scanState.cameraOverlayVisible,
    scanCameraStatus: scanState.cameraStatus,
    scanCameraError: scanState.cameraError,
    scanCameraActive: scanState.cameraActive,
    scanCameraVideoRef: scanState.cameraVideoRef,
    scanCameraRequested: scanState.cameraRequested,
    startScanCamera: scanState.startCameraScan,
    stopScanCamera: scanState.stopCameraScan,
    scanReviewData: scanState.scanReviewData,
    scanReviewOpen: scanState.scanReviewOpen,
    scanReviewError: scanState.scanReviewError,
    scanReviewSubmitting: scanState.scanReviewSubmitting,
    beginScanReview: scanState.beginScanReview,
    cancelScanReview: scanState.cancelScanReview,
    updateScanReviewField: scanState.updateScanReviewField,
    submitScanReview: scanState.submitScanReview,
