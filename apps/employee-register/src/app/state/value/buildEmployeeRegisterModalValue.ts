...
export function buildEmployeeRegisterModalValue(params: EmployeeRegisterModalParams) {
  ...
  return {
    ...
    scanFormData: scanState.scanFormData,
    scanFormActiveField: scanState.scanFormActiveField,
    scanFormSubmitting: scanState.scanFormSubmitting,
    scanFormError: scanState.scanFormError,
    scanFormEditing: scanState.scanFormEditing,
    setScanFormEditing: scanState.setScanFormEditing,
    updateScanFormField: scanState.updateScanFormField,
    submitScanForm: scanState.submitScanForm,
    clearScanForm: scanState.clearScanForm,
    scanFormCanSubmit: scanState.scanFormCanSubmit,
