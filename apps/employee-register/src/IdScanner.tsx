        ...
        <div style={{
          ...
          <div style={{ marginBottom: '1rem' }}>
            <div style={{ marginBottom: '0.5rem' }}>
              <strong>Name:</strong> {scannedData.fullName || `${scannedData.firstName || ''} ${scannedData.lastName || ''}`.trim() || 'N/A'}
            </div>
            {scannedData.dob && (
              <div style={{ marginBottom: '0.5rem' }}>
        ...
        <>
          ...
          {scanning && !error && (
            <div style={{
              ...
              <p style={{ fontSize: '0.875rem', color: '#94a3b8' }}>Point camera at the barcode on the back of the ID</p>
            </div>
          )}
